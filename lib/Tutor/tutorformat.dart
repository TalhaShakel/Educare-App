                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Center(child: Text("Visit home of students",
                                  style: GoogleFonts.poppins(
                                    color: Colors.white,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              margin: EdgeInsets.all(10),
                              padding: EdgeInsets.all(5),
                              child: Center(child: Text("Students visit your home",
                                  style: GoogleFonts.poppins(
                                    color: Colors.black,
                                    fontSize: MediaQuery.of(context).size.width/25,
                                  )),),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              margin: EdgeInsets.all(10),
                              padding: EdgeInsets.all(5),
                              child: Center(child: Text("Group classes somewhere",
                                  style: GoogleFonts.poppins(
                                    color: Colors.black,
                                    fontSize: MediaQuery.of(context).size.width/25,
                                  )),),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              margin: EdgeInsets.all(10),
                              padding: EdgeInsets.all(5),
                              child: Center(child: Text("Distance online class",
                                  style: GoogleFonts.poppins(
                                    color: Colors.black,
                                    fontSize: MediaQuery.of(context).size.width/25,
                                  )),),
                          ...
                          Padding(
                            padding: EdgeInsets.only(left: 30,right: 30,top: 10,bottom: MediaQuery.of(context).size.height/13),
                            child: InkWell(
                              onTap: (){
