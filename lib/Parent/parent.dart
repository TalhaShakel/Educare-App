      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text("I am a Parent",style: GoogleFonts.poppins(
                color: Colors.black,fontWeight: FontWeight.bold,fontSize: MediaQuery.of(context).size.width/15,
              ),),
              Padding(
                padding: const EdgeInsets.only(top: 10),
                child: Text("Manage payments or lessons for",style:GoogleFonts.poppins(
                  fontSize: MediaQuery.of(context).size.width/25,
                ) ),
              ),
              Text("your child.",style:GoogleFonts.poppins(
                fontSize: MediaQuery.of(context).size.width/25,
              ) ),
              Padding(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(left: 30,right: 30,top: 20,bottom: MediaQuery.of(context).size.height/14,),
                            child: InkWell(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>parentinfo()));
                              },
                              child: Container(
                                width:343,
                                height: 67,
