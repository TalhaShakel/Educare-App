                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child:  Image.asset("assets/images/Notification.png",width: 35,height: 35),),
                    ),
                  ],
                ),
                Padding(
                  padding: EdgeInsets.only(top: MediaQuery.of(context).size.width/20),
                  child: Image.asset("assets/images/anna.png",width: MediaQuery.of(context).size.width,),
                ),
                SizedBox(
                    ...
                    children: [
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Icon(Icons.star, color: Color(0xffFFCD32),),
                          ...
                          Row(
                            children: [
                              ...
                              Icon(Icons.book, color: Color(0xffFFCD32),),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text("Set your Avalibility",style: GoogleFonts.almarai(
                              color: Colors.white,
                  ...
                  child: Column(
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Your Class",style: GoogleFonts.poppins(
                              color: Color(0xff213E50),
                              fontWeight: FontWeight.bold,
                              fontSize: 15
                  ...
                  child: Column(
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Your Student",style: GoogleFonts.poppins(
                              color: Color(0xff213E50),
                              fontWeight: FontWeight.bold,
                              fontSize: 15
                          ...
                          InkWell(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>Yourstudents()));
                            },
                            child: Text("See all",style: GoogleFonts.poppins(
                                color: Color(0xffFFCD32),
                                fontWeight: FontWeight.bold,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text("Experienced online tutor in Psychology,Mathematics,Music Theory, and Biology for students looking...",
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Row(children: [
                                          Text("£50",style: GoogleFonts.poppins(color: Color(0xffFFCD32),fontSize: 17,fontWeight: FontWeight.bold),),
                                          Text("/hrs",style: GoogleFonts.poppins(color: Color(0xffFFCD32),fontSize: 8,fontWeight: FontWeight.bold),)
                                        ],),
