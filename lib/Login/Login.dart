        ...
        children: [
          Padding(
            ...
            child: Column(
              children: [
                Padding(
                  padding: EdgeInsets.only(top: MediaQuery.of(context).size.width/6, bottom: MediaQuery.of(context).size.width/40,),
                  child: Image(
                                ...
                                return Padding(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                          child: Wrap(
                                            children: <Widget>[
                                              Image.asset("assets/images/btmsheetimage.png"),
                                              SizedBox(
                                                height: 20,
                                              ),
                                              Center(
                                                child: Column(
                                                  children: [
                                                    Text("Email Verification",style: GoogleFonts.poppins(
                                                                  ...
                                                                  child: Wrap(
                                                                    children: <Widget>[
                                                                      ...
                                                                      Center(
                                                                        child: Column(
                                                                          children: [
                                                                            Text("Get Your Code",style: GoogleFonts.poppins(
                                                                              fontSize: MediaQuery.of(context).size.width/16,
                                                                              fontWeight: FontWeight.w600,
                                                                            ),),
                                                                                                  ...
                                                                                                  Center(
                                                                                                    child: Column(
                                                                                                      children: [
                                                                                                        ...
                                                                                                        //3rdpopup button
                                                                                                        Padding(
                                                                                                          padding: EdgeInsets.only(top: MediaQuery.of(context).size.width/10, left: MediaQuery.of(context).size.width/35, right: MediaQuery.of(context).size.width/35,),
                                                                                                          child: InkWell(
                                                                                                            onTap: (){
                                                                                                            ...
                                                                                                            child: Container(
                                                                                                              ...
                                                                                                              child: Center(child: Text("Continue",style: GoogleFonts.almarai(
                                                                                                                  color: Colors.white
                                                                                                              ),)),
                                                                                                            ),
                                                                                                          ),
          ...
          Padding(
            ...
            child: InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>areyou()));
              },
              child: Container(
                width:343,
                height: 67,
