      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text("Ask your parent",style:GoogleFonts.poppins(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Padding(
                            padding: EdgeInsets.only(top: MediaQuery.of(context).size.width/200, left: MediaQuery.of(context).size.width/30,),
                            child: Image(
                          ...
                          Padding(
                            padding: EdgeInsets.only(left: 30,right: 30,top: 10,bottom: MediaQuery.of(context).size.height/15),
                            child: InkWell(
                              onTap: (){
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("Connect with your Parent",style: GoogleFonts.almarai(
                                    color: Colors.white,
                                  fontSize: MediaQuery.of(context).size.width/20,
                                ),)),
                              ),
